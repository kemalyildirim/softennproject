          ...
          <div class="row">
            ...
            <aside class="col-sm-7">
              <article class="card-body p-5">
                <h3 class="title mb-3">{{carInfo.car_brand}} - {{carInfo.car_model}}</h3>

                <p class="price-detail-wrap">
                  <span class="price h3 text-warning">
                    <span class="currency">TL ₺</span>
                    <span class="num">{{carInfo.car_daily_price * diffDays * quantity}}</span>
                  </span>
                  <span  v-if="diffDays <= 1" >/for {{diffDays}} day</span>
                  <span  v-else>/for {{diffDays}} days</span>
                </p>
                  ...
                  <dd>
                    <div class="row">
                      <div class="col-6 col-md-6">
                        <li>Air Conditioner: {{carInfo.car_has_ac}}</li>
                        <li>Car Class: {{carInfo.car_price_class}}</li>
                        <li>Number of Doors: {{carInfo.car_numberof_doors}}</li>
                      </div>
                      <div class="col-6 col-md-6">
                        <li>Fuel: {{carInfo.car_fueltype}}</li>
                        <li>Gear: {{carInfo.car_geartype}}</li>
                        <li>Number of Seats: {{carInfo.car_numberof_seats}}</li>
                      </div>
                    </div>
                  </dd>
                </dl>
                ...
                <div class="row">
                  <button
                    ...
                    class="btn btn-dark btn-lg col-12 col-md-12 mx-auto collapsed">Rent Now</button>
                </div>
              </article>
            </aside>
          </div>
    ...
    confirm() {
     axios.post("http://localhost:8080/api/customer/save",
      ...
      axios.get("http://localhost:8080/api/customer/last").then((response) => {
        ...
        console.log("last "+this.customerID);
        console.log("car id "+this.carID);
      }).catch((err) => {
